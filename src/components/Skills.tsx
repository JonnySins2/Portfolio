...
const translations = {
  FR: { titleLeft: 'Mes ', titleRight: 'Compétences' },
  EN: { titleLeft: 'My ',  titleRight: 'Skills' },
};

export default function Skills({ theme, lang }: SkillsProps) {
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 w-full max-w-6xl">
          {skillsData[lang].map((category, index) => {
